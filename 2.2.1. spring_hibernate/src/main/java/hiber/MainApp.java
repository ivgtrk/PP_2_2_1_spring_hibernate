...
public class MainApp {
   public static void main(String[] args) throws SQLException {
      ...
      System.out.println("Search User by Car series 3 and model3...");
      User findUser = userService.getUser("model3", 3);
      System.out.println("Car's owner: " + findUser.getFirstName() + " "
